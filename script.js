let students = [
    { ID: 1, name: 'Dinesh Karthik', age: 21, grade: 'A', degree: 'BSC', email: 'karthik13@example.com' },
    { ID: 2, name: 'Balaji Pawar', age: 20, grade: 'B', degree: 'B.COM', email: 'balaji07@example.com' },
    { ID: 3, name: 'Jaswa', age: 22, grade: 'C', degree: 'BTECH', email: 'jaswa17@example.com' }
];
let addStudent ;
let editStudent ;
let searchField ;
